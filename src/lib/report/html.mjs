...
<div class="wrap">
  <header class="masthead">
    <div class="masthead-top">
      ...
      <button id="maskToggle" class="maskbtn" type="button" aria-pressed="false">
        <svg class="ic ic-eye" viewBox="0 0 24 24" aria-hidden="true"><path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7z"/><circle cx="12" cy="12" r="3"/></svg>
        <svg class="ic ic-eye-off" viewBox="0 0 24 24" aria-hidden="true"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
        <span class="lbl">Show sensitive values</span>
      </button>
    </div>
    <div class="meta">
...
<script>
// Sensitive-value masking. Enabled by default (body.masked) so the report can
// be screenshotted or shared without leaking tokens, project names, or session
// IDs. The button toggles the blur off/on.
(function () {
  const btn = document.getElementById("maskToggle")
  const lbl = btn.querySelector(".lbl")
  function setMasked(on) {
    document.body.classList.toggle("masked", on)
    lbl.textContent = on ? "Show sensitive values" : "Hide sensitive values"
    btn.setAttribute("aria-pressed", String(!on))
  }
  btn.addEventListener("click", () => setMasked(!document.body.classList.contains("masked")))
  setMasked(true)
})();
